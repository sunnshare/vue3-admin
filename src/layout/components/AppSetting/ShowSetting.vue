<template>
  ...
  <ul>
    ...
    <li class="flex-y-center justify-between py-1">
      ...
      <el-switch
        :model-value="themeStore.breadCrumb"
        @change="themeStore.setBreadCrumb"
      />
    </li>
    <li class="flex-y-center justify-between py-1">
      <div>{{ $t("setting.navTab") }}</div>
      <el-switch
        :model-value="themeStore.navTab"
        @change="themeStore.setNavTab"
      />
    </li>
    <li class="flex-y-center justify-between py-1">
      <div>{{ $t("setting.navTabIcon") }}</div>
      <el-switch
        :model-value="themeStore.navTabIcon"
        @change="themeStore.setNavTabIcon"
      />
    </li>
    <li class="flex-y-center justify-between py-1">
      <div>{{ $t("setting.menuUnique") }}</div>
      <el-switch
        :model-value="themeStore.menuUnique"
        @change="themeStore.setMenuUnique"
      />
    </li>
    <li class="flex-y-center justify-between py-1">
